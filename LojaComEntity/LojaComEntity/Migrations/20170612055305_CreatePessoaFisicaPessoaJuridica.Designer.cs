...
namespace LojaComEntity.Migrations
{
    ...
    [Migration("20170612055305_CreatePessoaFisicaPessoaJuridica")]
    partial class CreatePessoaFisicaPessoaJuridica
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("LojaComEntity.Entidades.PessoaJuridicaDAO", b =>
                {
                    b.HasBaseType("LojaComEntity.Entidades.Usuario");

                    b.Property<int>("CNPJ");

                    b.HasAnnotation("Relational:DiscriminatorValue", "PessoaJuridicaDAO");
                });
